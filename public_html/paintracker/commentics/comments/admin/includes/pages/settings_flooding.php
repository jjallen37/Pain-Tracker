...
<p />
<label class='settings_flooding'><?php echo CMTX_FIELD_LABEL_TIME ?></label> <input type="text" name="flood_control_delay_time" size="1" maxlength="250" value="<?php echo $cmtx_settings->flood_control_delay_time; ?>"/> <span class='note'><?php echo CMTX_NOTE_SECONDS ?></span>
<p />
...
<p />
<label class='settings_flooding'><?php echo CMTX_FIELD_LABEL_AMOUNT ?></label> <input type="text" name="flood_control_maximum_amount" size="1" maxlength="250" value="<?php echo $cmtx_settings->flood_control_maximum_amount; ?>"/>
<p />
<label class='settings_flooding'><?php echo CMTX_FIELD_LABEL_PERIOD ?></label> <input type="text" name="flood_control_maximum_period" size="1" maxlength="250" value="<?php echo $cmtx_settings->flood_control_maximum_period; ?>"/> <span class='note'><?php echo CMTX_NOTE_HOURS ?></span>
<p />
