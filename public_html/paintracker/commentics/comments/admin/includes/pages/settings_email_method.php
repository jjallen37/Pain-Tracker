...
<p />
<label class='settings_email_method'><?php echo CMTX_FIELD_LABEL_SMTP_HOST ?></label> <input type="text" name="smtp_host" size="20" maxlength="250" value="<?php echo $cmtx_settings->smtp_host; ?>"/>
<p />
<label class='settings_email_method'><?php echo CMTX_FIELD_LABEL_SMTP_PORT ?></label> <input type="text" name="smtp_port" size="1" maxlength="250" value="<?php echo $cmtx_settings->smtp_port; ?>"/>
<p />
...
<p />
<label class='settings_email_method'><?php echo CMTX_FIELD_LABEL_SENDMAIL_PATH ?></label> <input type="text" name="sendmail_path" size="20" maxlength="250" value="<?php echo $cmtx_settings->sendmail_path; ?>"/>
</div>
<p />
