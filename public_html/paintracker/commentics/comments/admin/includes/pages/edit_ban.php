...
<label class='edit_ban'><?php echo CMTX_FIELD_LABEL_IP_ADDRESS ?></label> <input type="text" name="ip_address" size="20" maxlength="250" value="<?php echo htmlentities($ip_address, ENT_NOQUOTES, 'UTF-8'); ?>"/>
<p />
<label class='edit_ban'><?php echo CMTX_FIELD_LABEL_REASON ?></label> <input type="text" name="reason" size="20" maxlength="250" value="<?php echo htmlentities($reason, ENT_NOQUOTES, 'UTF-8'); ?>"/>
<p />
