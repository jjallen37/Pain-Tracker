...
<p />
<label class='layout_form_general'><?php echo CMTX_FIELD_LABEL_FORM_COOKIE_DAYS ?></label> <input type="text" name="form_cookie_days" size="1" maxlength="3" value="<?php echo $cmtx_settings->form_cookie_days; ?>"/> <span class='note'><?php echo CMTX_NOTE_DAYS ?></span>
