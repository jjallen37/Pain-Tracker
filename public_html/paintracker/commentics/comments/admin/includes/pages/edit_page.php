...
<p />
<label class='edit_page'><?php echo CMTX_FIELD_LABEL_PAGE_ID ?></label> <input type="text" name="page_id" size="30" maxlength="250" value="<?php echo $page_id; ?>"/>
<p />
