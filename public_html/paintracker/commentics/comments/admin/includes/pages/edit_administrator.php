...
echo cmtx_page_checkbox("tasks", $id, "0") . "<span class='menu_checkbox'>Tasks</span>" . "<p />";
	echo cmtx_page_checkbox("task_del_bans", $id, "20") . "Del Bans" . "<br />";
	echo cmtx_page_checkbox("task_del_reports", $id, "20") . "Del Reports" . "<br />";
	echo cmtx_page_checkbox("task_del_voters", $id, "20") . "Del Voters" . "<br />";
	echo cmtx_page_checkbox("task_del_comment_ips", $id, "20") . "Del Comment IPs" . "<br />";
	echo cmtx_page_checkbox("task_del_unconfirmed_subs", $id, "20") . "Del Unconfirmed Subs" ."<br />";
	echo cmtx_page_checkbox("task_del_inactive_subs", $id, "20") . "Del Inactive Subs" . "<br />";
	echo cmtx_page_checkbox("task_re_act_inactive_subs", $id, "20") . "Re-Act Inactive Subs" . "<p />";
