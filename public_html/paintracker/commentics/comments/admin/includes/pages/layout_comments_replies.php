...
<p />
<label class='layout_comments_replies'><?php echo CMTX_FIELD_LABEL_REPLY_DEPTH ?></label> <input type="text" name="reply_depth" size="1" maxlength="250" value="<?php echo $cmtx_settings->reply_depth; ?>"/>
