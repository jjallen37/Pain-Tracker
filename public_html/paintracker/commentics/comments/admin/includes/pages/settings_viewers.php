...
<p />
<label class='settings_viewers'><?php echo CMTX_FIELD_LABEL_TIMEOUT ?></label> <input type="text" name="viewers_timeout" size="1" maxlength="250" value="<?php echo $cmtx_settings->viewers_timeout; ?>"/> <span class='note'><?php echo CMTX_NOTE_SECONDS ?></span>
...
<p />
<label class='settings_viewers'><?php echo CMTX_FIELD_LABEL_INTERVAL ?></label> <input type="text" name="viewers_refresh_time" size="1" maxlength="250" value="<?php echo $cmtx_settings->viewers_refresh_time; ?>"/> <span class='note'><?php echo CMTX_NOTE_SECONDS ?></span>
