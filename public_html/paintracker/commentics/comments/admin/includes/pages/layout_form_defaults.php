...
<p />
<label class='layout_form_defaults'><?php echo CMTX_FIELD_LABEL_EMAIL ?></label> <input type="text" name="default_email" size="33" maxlength="250" value="<?php echo $cmtx_settings->default_email; ?>"/>
<p />
...
if ($cmtx_settings->default_country != "blank") {
	$countries = str_ireplace('"'.$cmtx_settings->default_country.'"', '"'.$cmtx_settings->default_country.'" selected="selected"', $countries);
}
echo $countries;
?>
<p />
...
if ($cmtx_settings->default_rating != "blank") {
	$ratings = str_ireplace('"'.$cmtx_settings->default_rating.'"', '"'.$cmtx_settings->default_rating.'" selected="selected"', $ratings);
}
echo $ratings;
?>
<p />
