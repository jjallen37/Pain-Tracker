...
<p />
<label class='settings_security'><?php echo CMTX_FIELD_LABEL_BAN_COOKIE ?></label> <input type="text" name="ban_cookie_days" size="1" maxlength="3" value="<?php echo $cmtx_settings->ban_cookie_days; ?>"/> <span class='note'><?php echo CMTX_NOTE_DAYS ?></span>
