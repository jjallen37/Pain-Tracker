...
define('CMTX_APPROVAL_SUBSCRIBER', 'Подтверждение отправлено Вам по электронной почте.');

/* Success box */
define('CMTX_SUCCESS_OPENING', 'Спасибо.');
define('CMTX_SUCCESS_TEXT', 'Ваш комментарий добавлен.');
define('CMTX_SUCCESS_SUBSCRIBER', ' Подтверждение отправлено Вам по электронной почте.');
...
define('CMTX_ERROR_MESSAGE_INVALID_NAME', 'Имя может содержать только буквы и символы - & . 0-9 \'');
...
define('CMTX_ERROR_MESSAGE_DEFAULT_WEBSITE', 'Поле сайт не может содержать значение по умолчанию. Пожалуйста, введите Ваш сайт.');
...
define('CMTX_ERROR_MESSAGE_INVALID_TOWN', 'Поле город может содержать только буквы и символы - & . \'');
...
define('CMTX_BAN_MESSAGE_BANNED_NOW', 'Вы только что были забанены.<p/> Это может быть следствием различных причин, включая ругань, спам и действия, расценивающиеся как хакерство. <p/>Если Вы считаете, что произошла ошибка, пожалуйста, обратитесь к администратору, указав Ваш IP-адрес.');
