...
define('CMTX_NOT_CONFIRMED', 'Ваша подписка пока не подтверждена.');
define('CMTX_ACTIVATED', 'Ваша подписка теперь действительна.');
define('CMTX_ALREADY_ACTIVATED', 'Ваша подписка уже действительна.');
