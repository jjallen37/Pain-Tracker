...
define('CMTX_ANCHOR_OPEN', '#cmtx_open');
...
define('CMTX_RECAPTCHA_NO_KEY', '<b>Warning</b>: API key(s) missing in Settings -> ReCaptcha');
...
define('CMTX_TEXT_PRIVACY', 'I have read and understand the <a href="' . $cmtx_settings->url_to_comments_folder . 'agreement/english/privacy_policy.html" title="View privacy policy" target="_blank" rel="nofollow">privacy policy</a>.');

/* Text displayed after terms checkbox */
define('CMTX_TEXT_TERMS', 'I have read and agree to the <a href="' . $cmtx_settings->url_to_comments_folder . 'agreement/english/terms_and_conditions.html" title="View terms and conditions" target="_blank" rel="nofollow">terms and conditions</a>.');
