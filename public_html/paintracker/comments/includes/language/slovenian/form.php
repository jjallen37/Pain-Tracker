...
define('CMTX_TEXT_PRIVACY', 'Strinjam se z vsebino <a href="' . $cmtx_settings->url_to_comments_folder . 'agreement/slovenian/privacy_policy.html" title="Ogled politike zasebnosti." target="_blank" rel="nofollow">politike zasebnosti</a>.');

/* Text displayed after terms checkbox */
define('CMTX_TEXT_TERMS', 'Strinjam se s <a href="' . $cmtx_settings->url_to_comments_folder . 'agreement/slovenian/terms_and_conditions.html" title="Pogoji uporabe." target="_blank" rel="nofollow">pogoji uporabe</a>.');
