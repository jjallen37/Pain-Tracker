...
<?php if (!cmtx_restrict_page("manage")) { ?> <li><a href="#" rel="manage"><?php echo CMTX_MENU_TITLE_MANAGE ?></a></li> <?php } ?>
<?php if (!cmtx_restrict_page("layout")) { ?> <li><a href="#" rel="layout"><?php echo CMTX_MENU_TITLE_LAYOUT ?></a></li> <?php } ?>
<?php if (!cmtx_restrict_page("settings")) { ?> <li><a href="#" rel="settings"><?php echo CMTX_MENU_TITLE_SETTINGS ?></a></li> <?php } ?>
<?php if (!cmtx_restrict_page("tasks")) { ?> <li><a href="#" rel="tasks"><?php echo CMTX_MENU_TITLE_TASKS ?></a></li> <?php } ?>
<?php if (!cmtx_restrict_page("reports")) { ?> <li><a href="#" rel="reports"><?php echo CMTX_MENU_TITLE_REPORTS ?></a></li> <?php } ?>
<?php if (!cmtx_restrict_page("tools")) { ?> <li><a href="#" rel="tools"><?php echo CMTX_MENU_TITLE_TOOLS ?></a></li> <?php } ?>
...
<?php if (!cmtx_restrict_page("task_del_bans")) { ?> <li><a href="index.php?page=task_del_bans"><?php echo CMTX_MENU_TITLE_TASK_DEL_BANS ?></a></li> <?php } ?>
<?php if (!cmtx_restrict_page("task_del_reports")) { ?> <li><a href="index.php?page=task_del_reports"><?php echo CMTX_MENU_TITLE_TASK_DEL_REPORTS ?></a></li> <?php } ?>
<?php if (!cmtx_restrict_page("task_del_voters")) { ?> <li><a href="index.php?page=task_del_voters"><?php echo CMTX_MENU_TITLE_TASK_DEL_VOTERS ?></a></li> <?php } ?>
<?php if (!cmtx_restrict_page("task_del_comment_ips")) { ?> <li><a href="index.php?page=task_del_comment_ips"><?php echo CMTX_MENU_TITLE_TASK_DEL_COMMENT_IPS ?></a></li> <?php } ?>
<?php if (!cmtx_restrict_page("task_del_unconfirmed_subs")) { ?> <li><a href="index.php?page=task_del_unconfirmed_subs"><?php echo CMTX_MENU_TITLE_TASK_DEL_UNCONFIRMED_SUBS ?></a></li> <?php } ?>
<?php if (!cmtx_restrict_page("task_del_inactive_subs")) { ?> <li><a href="index.php?page=task_del_inactive_subs"><?php echo CMTX_MENU_TITLE_TASK_DEL_INACTIVE_SUBS ?></a></li> <?php } ?>
<?php if (!cmtx_restrict_page("task_re_act_inactive_subs")) { ?> <li><a href="index.php?page=task_re_act_inactive_subs"><?php echo CMTX_MENU_TITLE_TASK_RE_ACT_INACTIVE_SUBS ?></a></li> <?php } ?>
</ul>
<?php } ?>
