...
<a class='page_help_text' href="#" onclick="show_hide('pages');"><?php echo CMTX_LINK_OPTIONS ?></a> /
...
mysql_query("DELETE FROM `" . $cmtx_mysql_table_prefix . "reports` WHERE `comment_id` = '$comment_id'");
}
