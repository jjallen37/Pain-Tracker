...
<p />
<label class='settings_maintenance'><?php echo CMTX_FIELD_LABEL_MESSAGE ?></label> <input type="text" name="message" size="65" maxlength="250" value="<?php echo $cmtx_settings->maintenance_message; ?>"/>
<p />
