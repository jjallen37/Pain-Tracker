...
<p />
<label class='settings_processor_comment'><?php echo CMTX_FIELD_LABEL_MIN_CHARS ?></label> <input type="text" name="comment_minimum_characters" size="1" maxlength="250" value="<?php echo $cmtx_settings->comment_minimum_characters; ?>"/>
<p />
<label class='settings_processor_comment'><?php echo CMTX_FIELD_LABEL_MIN_WORDS ?></label> <input type="text" name="comment_minimum_words" size="1" maxlength="250" value="<?php echo $cmtx_settings->comment_minimum_words; ?>"/>
<p />
<label class='settings_processor_comment'><?php echo CMTX_FIELD_LABEL_MAX_CHARS ?></label> <input type="text" name="comment_maximum_characters" size="3" maxlength="250" value="<?php echo $cmtx_settings->comment_maximum_characters; ?>"/>
<p />
<label class='settings_processor_comment'><?php echo CMTX_FIELD_LABEL_MAX_LINES ?></label> <input type="text" name="comment_maximum_lines" size="1" maxlength="250" value="<?php echo $cmtx_settings->comment_maximum_lines; ?>"/>
<p />
<label class='settings_processor_comment'><?php echo CMTX_FIELD_LABEL_MAX_SMILIES ?></label> <input type="text" name="comment_maximum_smilies" size="1" maxlength="250" value="<?php echo $cmtx_settings->comment_maximum_smilies; ?>"/>
<p />
<label class='settings_processor_comment'><?php echo CMTX_FIELD_LABEL_LONG_WORD ?></label> <input type="text" name="long_word_length_to_deny" size="1" maxlength="250" value="<?php echo $cmtx_settings->long_word_length_to_deny; ?>"/> <span class='note'><?php echo CMTX_NOTE_CHARS ?></span>
<p />
...
<p />
<label class='settings_processor_comment'><?php echo CMTX_FIELD_LABEL_MASK ?></label> <input type="text" name="swear_word_masking" size="4" maxlength="250" value="<?php echo $cmtx_settings->swear_word_masking; ?>"/>
...
<p />
<label class='settings_processor_comment'><?php echo CMTX_FIELD_LABEL_PERCENTAGE ?></label> <input type="text" name="check_capitals_percentage" size="1" maxlength="250" value="<?php echo $cmtx_settings->check_capitals_percentage; ?>"/> <span class='note'>%</span>
<p />
<label class='settings_processor_comment'><?php echo CMTX_FIELD_LABEL_ACTION ?></label>
