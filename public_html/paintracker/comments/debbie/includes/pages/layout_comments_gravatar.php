...
<p />
<label class='layout_comments_gravatar'><?php echo CMTX_FIELD_LABEL_GRAVATAR_SIZE ?></label> <input type="text" name="gravatar_size" size="1" maxlength="250" value="<?php echo $cmtx_settings->gravatar_size; ?>"/>
