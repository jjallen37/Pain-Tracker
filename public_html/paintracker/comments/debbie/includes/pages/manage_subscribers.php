...
mysql_query("INSERT INTO `" . $cmtx_mysql_table_prefix . "subscribers` (`name`, `email`, `page_id`, `token`, `is_confirmed`, `is_active`, `last_action`, `dated`) VALUES ('$name', '$email', '$page_id', '$token', '1', '1', NOW(), NOW());");
?>
