...
<p />
<label class='layout_comments_general'><?php echo CMTX_FIELD_LABEL_TIME_FORMAT ?></label> <input type="text" name="time_format" size="2" maxlength="250" value="<?php echo $cmtx_settings->time_format; ?>"/> &nbsp; <a href="http://www.commentics.org/support/knowledgebase.php?article=20" target="_blank"><?php echo CMTX_LINK_FAQ ?></a>
<p />
<label class='layout_comments_general'><?php echo CMTX_FIELD_LABEL_DATE_TIME ?></label> <input type="text" name="date_time_format" size="8" maxlength="250" value="<?php echo $cmtx_settings->date_time_format; ?>"/> &nbsp; <a href="http://www.commentics.org/support/knowledgebase.php?article=20" target="_blank"><?php echo CMTX_LINK_FAQ ?></a>
<p />
