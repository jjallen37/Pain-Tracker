...
<label class='settings_system'><?php echo CMTX_FIELD_LABEL_ADMIN_FOLDER ?></label> <input type="text" name="admin_folder" size="10" maxlength="250" value="<?php echo $cmtx_settings->admin_folder; ?>"/>
...
<p />
<label class='settings_system'><?php echo CMTX_FIELD_LABEL_COMMENTS_URL ?></label> <input type="text" name="url_to_comments_folder" size="45" maxlength="250" value="<?php echo $cmtx_settings->url_to_comments_folder; ?>"/>
...
<p />
<label class='settings_system'><?php echo CMTX_FIELD_LABEL_LIMIT_COMMENTS ?></label> <input type="text" name="limit_comments" size="3" maxlength="250" value="<?php echo $cmtx_settings->limit_comments; ?>"/>
<?php cmtx_generate_hint(CMTX_HINT_LIMIT_COMMENTS); ?>
<p />
<label class='settings_system'><?php echo CMTX_FIELD_LABEL_ADMIN_COOKIE_DAYS ?></label> <input type="text" name="admin_cookie_days" size="1" maxlength="3" value="<?php echo $cmtx_settings->admin_cookie_days; ?>"/> <span class='note'><?php echo CMTX_NOTE_DAYS ?></span>
