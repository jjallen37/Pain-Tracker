...
<p />
<label class='layout_comments_pagination'><?php echo CMTX_FIELD_LABEL_PER_PAGE ?></label> <input type="text" name="comments_per_page" size="1" maxlength="250" value="<?php echo $cmtx_settings->comments_per_page; ?>"/>
<?php cmtx_generate_hint(CMTX_HINT_PAGINATION_PER_PAGE); ?>
<p />
<label class='layout_comments_pagination'><?php echo CMTX_FIELD_LABEL_RANGE ?></label> <input type="text" name="range_of_pages" size="1" maxlength="250" value="<?php echo $cmtx_settings->range_of_pages; ?>"/>
