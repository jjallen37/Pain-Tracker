...
<p />
<label class='layout_comments_read_more'><?php echo CMTX_FIELD_LABEL_LIMIT ?></label> <input type="text" name="read_more_limit" size="1" maxlength="250" value="<?php echo $cmtx_settings->read_more_limit; ?>"/> <span class='note'><?php echo CMTX_NOTE_CHARS ?></span>
<p />
