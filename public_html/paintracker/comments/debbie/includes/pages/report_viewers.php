...
?>
    	<tr>
        	<?php if (!empty($viewer["user_agent"]) && cmtx_is_spider($viewer["user_agent"])) { ?> <td><img src="<?php echo "images/viewers/spider.png";?>" class="viewer" title="Spider" alt="Spider"></td> <?php } else { ?> <td><img src="<?php echo "images/viewers/person.png";?>" class="viewer" title="Person" alt="Person"></td> <?php } ?>
