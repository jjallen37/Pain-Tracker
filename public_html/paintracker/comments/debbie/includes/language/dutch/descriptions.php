...
define('CMTX_DESC_LAYOUT_FORM_ENABLED_1', 'Deze instelling bepaald of alle formulieren zijn ingeschakeld.');
define('CMTX_DESC_LAYOUT_FORM_ENABLED_2', 'Deze instellingen bepalen welke delen van het formulier zijn ingeschakeld.');
...
define('CMTX_DESC_TASK_DELETE_REPORTS', 'Deze taak verwijderd automatisch rapporten die ouder zijn dan de ingestelde periode.');
define('CMTX_DESC_TASK_DELETE_VOTERS', 'Deze taak verwijderd automatisch stemmers die ouder zijn dan de ingestelde periode.');
define('CMTX_DESC_TASK_DELETE_COM_IPS', 'Deze taak verwijderd automatisch berichten IP adressen die ouder zijn dan de ingestelde periode.');
define('CMTX_DESC_TASK_DELETE_UNCONFIRMED_SUBS', 'Deze taak verwijderd automatisch inschrijvers die niet hebben bevestigd en ouder zijn dan de ingestelde periode.');
define('CMTX_DESC_TASK_DELETE_INACTIVE_SUBS', 'Deze taak verwijderd automatisch inschrijvers die inactief zijn langer dan de ingestelde periode.');
define('CMTX_DESC_TASK_REACTIVATE_INACTIVE_SUBS', 'This task automatically re-activates subscribers who have been inactive for longer than the configured time period.');
